import 'dart:async';
import 'package:ecco_build/data/remote/api/api_helper.dart';
...
void main() {
  runApp(BlocProvider(create: (context)=>RegisterBloc(apiHelper: ApiHelper()),
  child: splash_screen()));
}
      ...
      body: Center(
        child: Stack(
          children: [Container(
            ...
            child: Image.asset("assets/images/build_logo.png",),
          ),
            Column(
